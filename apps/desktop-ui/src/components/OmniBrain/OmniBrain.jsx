...
const OmniBrain = ({ onClose }) => {
    ...
    const handleSend = async () => {
        ...
        try {
            ...
            setMessages(prev => prev.map(msg =>
                msg.id === thinkingId
                    ? { ...msg, text: data.reply, isThinking: false }
                    : msg
            ));
    ...
    return (
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[600px] h-[400px] bg-black/80 backdrop-blur-xl border border-white/10 rounded-xl shadow-2xl flex flex-col overflow-hidden animate-in fade-in zoom-in duration-300 z-50">
