...
// document.body.style.overflow = "hidden"; // React handles this usually
...
canvas.style.backgroundColor = "transparent"; // WAS BLACK
canvas.style.pointerEvents = "none"; // WAS BLOCKING CLICKS
